      ...
      <div className="mx-20 flex justify-between items-start gap-12">
        <div className="max-w-95">
          ...
          <div className="flex mt-6 gap-5 ">
            <a href="privacy-policy" className="font-bold text-sm uppercase underline underline-offset-4 text-primary">
              Privacy Policy
            </a>
            <a href="cookies" className="font-bold text-sm uppercase underline underline-offset-4  text-primary">
              Cookie Policy
            </a>
          </div>
        </div>
        <div className="flex gap-16">
          <div>
            ...
            <div className="mb-2 max-w-100">For questions or to report issues, <a
                href="contact-us"
                className=" items-center gap-2 font-semibold underline underline-offset-4 text-primary"
              >
                Contact Us
              </a>  or reach out to William Wei on:</div>

            <div className="flex gap-3 mt-1">
              <a
                href="https://linkedin.com/in/williamwei0"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 font-semibold uppercase underline underline-offset-4 text-primary"
              >
              ...
              <a
                href="https://github.com/william-wei0"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 font-semibold uppercase underline underline-offset-4 text-primary"
              >
